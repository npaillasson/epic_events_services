...
class LoginPageTests(TestCase):
    ...
    def setUp(self):
        User.objects.create_user(email=GESTION_USER_EMAIL, password=PASSWORD_TEST,
                                 first_name="John", last_name="Doe", team="1")
        User.objects.create_user(email=BUSINESS_USER_EMAIL, password=PASSWORD_TEST,
                                 first_name="John", last_name="Doe", team="2")
        User.objects.create_user(email=SUPPORT_USER_EMAIL, password=PASSWORD_TEST,
