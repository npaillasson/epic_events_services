...
from .custom_functions import (
    username_creation,
    assignment_of_groups,
    assignement_is_superuser,
)
...
class User(AbstractUser):
    ...
    first_name = models.CharField(
        "prénom", blank=False, max_length=150, validators=[has_not_number]
    )
    last_name = models.CharField(
        "Nom de famille", blank=False, max_length=150, validators=[has_not_number]
    )
